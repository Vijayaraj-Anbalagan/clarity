    ...
    <div className="relative bg-black text-white min-h-screen flex flex-col">
      ...
      <header className="flex flex-col items-center justify-center text-center py-20 px-4 relative z-10">
        ...
        <h1 className="text-5xl font-extrabold mb-4 mt-6">
          Enhance Your Enterprise with{' '}
          <span className="text-yellow-400">Clarity</span>
        </h1>
        <p className="text-lg max-w-2xl mb-8">
          AI-driven assistant for seamless employee engagement, real-time
          ...
          {[
            {
              ...
              description:
                'Interact with an intelligent, context-aware assistant designed to provide precise information and support.',
            },
            {
              Icon: FaCogs,
              title: 'Workflow Automation',
              description:
                'Automate repetitive tasks and workflows, freeing up time for more critical activities.',
            },
            {
              Icon: FaDatabase,
              title: 'Real-Time Data Integration',
              description:
                'Seamlessly integrate and synchronize data using powerful tools like Firebase and Pinecone.',
            },
            {
              Icon: FaChartLine,
              title: 'Analytics Dashboard',
              description:
                'Gain insights into employee engagement and sentiment with comprehensive analytics and visualization.',
            },
          ].map((feature, index) => (
            <div
              key={index}
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-2 group-hover:text-yellow-400">
                {feature.title}
              </h3>
      ...
      <section id="about" className="py-20 px-6 bg-black">
        ...
        <p className="max-w-3xl mx-auto text-center mb-8 leading-relaxed text-gray-300">
          Clarity is a state-of-the-art AI assistant that leverages the power of
          Google Gemini, Pinecone, and LangChain to provide enterprises with
          intelligent, real-time support and insights. Whether you are looking
          to streamline operations or enhance employee engagement, Clarity is
          designed to adapt to your organizational needs.
        </p>
